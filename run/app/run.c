...
SYMBOL_INFO app_debug_sym[] = {
	...
	{{"mmaw",(P_ADDR)&mma8653_reg_write},"mma write: mmaw reg val"},
	{{"mmar",(P_ADDR)&mma8653_reg_show},"mma read: mmar reg count"},
	{{"i2cbw",(P_ADDR)&i2c_reg_byte_write},"i2c byte write: i2cbw adapt addr reg val"},
	{{"i2cbr",(P_ADDR)&i2c_reg_byte_show},"i2c byte read: i2cbr adapt addr reg count"},
	{{NULL,0},NULL}
};
